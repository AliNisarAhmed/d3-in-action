...
var normal2 = d3.randomLogNormal();
var normal3 = d3.randomUniform();
var sampleData1 = d3.range(100).map(function (d) {
  return normal();
});
var sampleData2 = d3.range(100).map(function (d) {
  return normal();
});
var sampleData3 = d3.range(100).map(function (d) {
  return normal();
});
var histoChart = d3.histogram();
histoChart.domain([-3, 3]).thresholds([-3, -2.5, -2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5, 2, 2.5, 3]).value(function (d) {
  return d;
});
var yScale = d3.scaleLinear().domain([-3, 3]).range([400, 0]);
var yAxis = d3.axisRight().scale(yScale).tickSize(300);
var svg = d3.select('#svgHisto');
...
svg.selectAll('g.violin').data([sampleData1, sampleData2, sampleData3]).enter().append('g').attr('class', 'violin').attr('transform', function (d, i) {
  return "translate(".concat(50 + i * 100, ", 0)");
...
},{}]},{},["../../.nvm/versions/node/v11.1.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","violinPlot.js"], null)
//# sourceMappingURL=/violinPlot.8cefbd8c.map